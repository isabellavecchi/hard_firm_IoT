...
#define STATE_FUNC(fname) state ## fname 
// X Macros
...
sm_state_t STATE_FUNC(SM_RESET)(sm_state_var_t *st)
{
...
sm_state_t STATE_FUNC(SM_WAIT_DIGITS)(sm_state_var_t *st)
{
	int c;
...
sm_state_t STATE_FUNC(SM_CHECK_CODE)(sm_state_var_t *st)
{
