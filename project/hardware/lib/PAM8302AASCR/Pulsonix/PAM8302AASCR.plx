...
//276896/1167680/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "PAM8302AASCR" (originalName "PAM8302AASCR")
	...
	(compDef "PAM8302AASCR" (originalName "PAM8302AASCR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "8" (pinName "VO-") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "5" (pinName "VO+") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "PAM8302AASCR"))
		...
		(attr "Mouser Part Number" "621-PAM8302AASCR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/PAM8302AASCR?qs=pYVYkI7xuRXTVZEQSGcDyg%3D%3D")
		(attr "Manufacturer_Name" "Diodes Incorporated")
		(attr "Manufacturer_Part_Number" "PAM8302AASCR")
		(attr "Description" "Amplifier IC 1-Channel (Mono) Class D 8-MSOP")
		(attr "<Hyperlink>" "https://www.diodes.com/assets/Datasheets/PAM8302A.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "PAM8302AASCR.stp")
