...
function getWifiConnectStatus()
{
    ...
    if (xhr.readyState == 4 && xhr.status == 200)
    {
        ...
        if(response.getWifiConnectStatus == 2)
        {
        ...
        else if (response.getWifiConnectStatus == 3)
        {
            document.getElementById("wifi_connect_status").innerHTML = "<h4 class='gr'>Connection Sucess!</h4>";
            stopWifiConnectStatusInterval();
        }
    }
}
...
/**
 * Connect WiFi function called using the SSIDand password entered into the text fields.
 */
function connectWifi(ssid, password)
{
    $.ajax({
        ...
        method:     'POST',
        cache:      false,
        headers:    {'my_connect-ssid': ssid, 'my-connect-pwd': pwd},
